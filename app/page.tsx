...
import GraficoObservatorio from "@/components/GraficoObservatorio";
...
const stats: [string, string][] = [
  ...
  [String(ODS_CORDOBA.length),    "ODS en Córdoba"   ],
  ["2030",                        "Meta Agenda"      ],
];
          ...
          <div style={{marginTop:"56px"}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"24px",flexWrap:"wrap",gap:"12px"}}>
              <div>
                ...
                <h3 style={{fontSize:"clamp(1.2rem,3vw,1.6rem)",fontWeight:800,color:"#0f172a",margin:0}}>
                  Encuesta ODS Córdoba
                </h3>
              </div>
              <a href="/encuesta" style={{
                display:"inline-flex",alignItems:"center",gap:"8px",
                background:"#1e40af",color:"white",fontWeight:700,
                padding:"10px 20px",borderRadius:"10px",textDecoration:"none",
                fontSize:"13px",boxShadow:"0 4px 16px rgba(30,64,175,.25)",
              }}>
                📝 Completar encuesta
              </a>
            </div>
            <div style={{
              background:"#f8fafc",borderRadius:"14px",padding:"32px",
        ...
        <div style={{maxWidth:"1200px",margin:"0 auto",padding:"0 24px"}}>
          ...
          <div style={{display:"flex",justifyContent:"center",marginTop:"48px"}}>
            <a href="/mapa" target="_blank" rel="noopener noreferrer"
              className="cta-btn"
              aria-label="Abrir el mapa interactivo de Córdoba en una nueva pestaña"
              style={{
                display:"inline-flex",alignItems:"center",gap:"8px",
                background:"#1e40af",color:"white",fontWeight:700,
