    ...
    <footer style={{background:"#020617",color:"#fff"}}>
      ...
      <div style={{maxWidth:"1200px",margin:"0 auto",padding:"52px 24px 28px"}}>
        <div
          ...
          style={{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"48px",marginBottom:"44px"}}
        >
          <div>
            <img
              src="/logos/agenda2030.png"
              alt="Logo Agenda 2030 Córdoba, Observatorio de Desarrollo Sostenible, UBP, ULA, BIOCBA"
              className="footer-logo-agenda"
          ...
          <div>
            <img
              ...
              className="footer-logo-instituciones"
        ...
        <div
          ...
          style={{borderTop:"1px solid #0f172a",paddingTop:"24px",
